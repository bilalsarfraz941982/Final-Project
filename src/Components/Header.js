  ...
  return (
    <div className='headermain' style={{backgroundImage:`url(${Headerbg})`}}>
      <div className='leftbox'>
        ...
        <Link to='/bookingpage' className='reservationButton'><button style={{backgroundColor:"rgb(244, 206, 20)" , height:"50px" , width:"200px" , borderRadius:"20px", fontSize:"large"}}>Reserve a table</button></Link>
      </div>
